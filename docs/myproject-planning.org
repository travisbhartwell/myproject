...
* Next Demo
** Minimal =mycmd myproject list-tasks= that prints project root and MyProject task definition root
SCHEDULED: <2025-01-03 Fri>
...
*** TODO Test that the config file can handle using =~= for home
*** TODO Test the priority of =MYPROJECT_MAPPING= over =MYPROJECT_MAPPING_CONFIG=
*** TODO Move tests to new file and re-organize based on implementation file order
*** TODO Implement minimal =mycmd myproject list-tasks= that calls =project.find_up=
