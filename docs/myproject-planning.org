...
*** TODO Create =myproject-tasks-lib= with name and function fields
*** TODO Create =myproject.register_task= accepting one or two arguments
*** TODO Write minimal test for =myproject.register_task= and task object methods
*** TODO Create a minimal =myproject/main= in test data
