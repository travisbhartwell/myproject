...
*** TODO Create =testing-support-lib= with common variable and setup and tear-down routines
*** TODO Recreate existing test suite, split up by functionality
*** TODO Capture shell trace logs to =_TEST_TRACE_FILE=
*** TODO Implement function to aggregate coverage files
*** TODO Implement function to render code with coverage
