...
*** TODO Set global variables for the project directory and task definition directory
*** TODO Reset these global variables in =project:task_registry._reset_registry=
*** TODO Modify =project:task_registry.get_task= to attempt to load =sub= if it is not loaded
